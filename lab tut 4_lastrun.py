...
expName = 'lab tut 4'  # from the Builder filename that created this script
expInfo = {
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/tanmayikalapatapu/Downloads/lab tut 4_lastrun.py',
...
trials = data.TrialHandler(nReps=24.0, method='sequential', 
    ...
    trialList=data.importConditions('/Users/tanmayikalapatapu/Downloads/lab report 4_data.xlsx'),
...
for thisTrial in trials:
    ...
    while continueRoutine:
        ...
        if key_resp.status == STARTED and not waitOnFlip:
            theseKeys = key_resp.getKeys(keyList=['z','x','c','v'], waitRelease=False)
...
# set up handler to look after randomisation of conditions etc
trials_2 = data.TrialHandler(nReps=24.0, method='random', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions('/Users/tanmayikalapatapu/Downloads/lab report 4_data.xlsx'),
